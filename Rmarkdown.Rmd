...
```{r load data}
#outcome data
EJscreen <- read.csv("EJ.csv")

#exposure geometry data
HOLC_map <- readOGR(dsn=path.expand("C:/Users/lmoubad/OneDrive - Emory University/Spatial Project/Data/HRS2020-Shapefiles/HRS2020"),
                            layer="HRS2020")
#exposure attribute data
HOLC_score <- read_excel("C:/Users/lmoubad/OneDrive - Emory University/Spatial Project/Data/Historic Redlining Score 2020.xlsx")
```
...
m <- merge(HOLC_map, HOLC_score, by.y='GEOID20')



ej_ga <- subset(EJ, STATE_NAME=="Georgia")
