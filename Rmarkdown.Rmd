...
```{r redline maps, warning=FALSE, message=FALSE, results='hide'}
=======
```{r redline maps}
>>>>>>> db556d9b490f3d9466c14fe24993854294b55be4
...
```{r redline maps output, message=FALSE, warning=FALSE, echo=FALSE}
atlanta_gmap + geom_polygon(aes(x=long,y=lat, group=group, fill=HRS10_bins), data=points_atlanta_2, color='black') + 
  scale_fill_manual(name = "Historic Redlining Score Quartile", 
                    labels = c("1" = "Low (Q1)", 
                               "2" = "Medium (Q2)", 
